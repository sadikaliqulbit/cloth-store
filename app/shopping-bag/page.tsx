    ...
    <section className="shopping-cart-section-style ">
      <div className="max-w-7xl mx-auto"> 
        <div className="flex items-center gap-6 mb-10">
          <h1 className="text-[13px] font-beatriceRegular font-medium">
            SHOPPING BAG
          </h1>
          ...
          <div className="flex items-center gap-2 text-sm">
            <div className="bg-white px-2 py-2">
              <Heart
                strokeWidth={1.7}
                className="h-2 w-2 left-1/2 rotate-[-50.22deg]"
              />
            </div>
            <span className="text-[11px] font-beatriceRegular font-medium text-[#8A8A8A]">
              FAVOURITES
            </span>
          </div>
        </div>
        ...
        <div className="grid grid-cols-1  lg:grid-cols-2 gap-20 lg:gap-52  "> 
                ...
                <div className="flex gap-4"> 
                  ...
                  <div className="flex flex-col justify-between items-center h-[253px]"> 
                    ...
                    <div className="flex flex-col items-center gap-3">
                      ...
                      <div className="w-8 h-8 bg-black border"></div>
                      <div className="flex flex-col items-center">
                        <button
                          onClick={() =>
                            updateQuantity(item.id, item.quantity - 1)
                          }
                          className="w-8 h-8 border hover:bg-gray-100"
                        >
                          −
                        </button>

                        <span className="w-8 h-8 border flex items-center justify-center">
                          {item.quantity}
                        </span>
          ...
          <div className="border border-[#C9C9C9] p-6  shadow-sm h-fit sticky top-6 w-full lg:max-w-[306px] mx-auto">
            <h2 className="text-[14px] font-semibold mb-6 font-beatriceDeckMedium ">
              ORDER SUMMARY
            </h2>
            ...
            <div className="flex justify-between">
              <p className="font-beatriceDeckMedium text-[16px]">
                TOTAL{" "}
                <span className="font-beatriceDeckMedium text-[12px] text-black/55">
                  (TAX INCL.)
                </span>{" "}
              </p>
            ...
            <button className="font-beatriceDeckMedium w-full bg-[#D9D9D9] text-[#000000] py-4 mt-6 transition" onClick={() => routes.push("./checkout")}>
              CONTINUE
            </button>
          </div>
        </div>
